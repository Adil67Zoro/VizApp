...
export default function P2P_5x5(){
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/chess/PathToPosition/5x5/${level}`)
            .then(res => {
    ...
    return(
        <div>
            <Header />
            <TwoChessboardsCreater xdim={5} ydim={5} InitialPosition={boardInitial} FinalPosition={boardFinal}/>
        </div>
    )
}