...
export default function P2P_8x8(){
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/chess/PathToPosition/8x8/${level}`)
            .then(res => {
    ...
    return(
        <div>
            <Header />
            <TwoChessboardsCreater xdim={8} ydim={8} InitialPosition={boardInitial} FinalPosition={boardFinal}/>
        </div>
    )
}