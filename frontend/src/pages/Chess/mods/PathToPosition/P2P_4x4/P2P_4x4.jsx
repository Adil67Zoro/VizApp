...
export default function P2P_4x4(){
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/chess/PathToPosition/4x4/${level}`)
            .then(res => {
    ...
    return(
        <div>
            <Header />
            <TwoChessboardsCreater xdim={4} ydim={4} InitialPosition={boardInitial} FinalPosition={boardFinal}/>
        </div>
    )
}